<template>
    ...
    <div class="yinxDet clearfix" id="yinxdet">
      ...
      <div class="dethead" @mousedown.prevent>
        ...
        <!--升级共享-->
        <div class="upgrade">
          <div class="detup mains" v-if="$store.state.detup">
            升级
          </div>
          <div class="defshared clearfix mains" v-if="$store.state.gXshow">
          ...
          <!--取消-->
          <div class="cancel mains" v-if="$store.state.cancel">
            取消
          </div>
          <!--展开 全屏-->
          <div class="defscreen mains" title="展开" v-if="$store.state.zKshow"></div>
          <!--写笔记完成-->
          <div class="writeNotesOk" v-if="$store.state.writeOk">
            完成
          </div>
        </div>
      </div>
